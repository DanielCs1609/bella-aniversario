    ...
    <section className="relative w-full min-h-screen bg-dark-900 px-6 py-24 flex flex-col items-center justify-center overflow-hidden">
      ...
      <div className="z-10 text-center max-w-4xl w-full flex flex-col items-center">
        ...
        <div className="w-full max-w-3xl flex flex-col md:flex-row gap-8 items-stretch">
          ...
          <div className="flex-1 rounded-2xl glass-panel-gold border border-gold/15 p-6 flex flex-col justify-between shadow-2xl">
            ...
            {songs.map((song) => {
              ...
              return (
                <button
                  ...
                  className={`w-full p-4 rounded-xl flex items-center gap-4 text-left border transition-all duration-300 cursor-pointer ${
                    isActive
                ...
                >
                  ...
                  <div className={`w-8 h-8 rounded-full flex items-center justify-center ${
                    isActive ? 'bg-gold text-dark-900' : 'bg-white/10 text-gold'
                  }`}>
